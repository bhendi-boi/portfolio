...
const ProjectCard = ({ name, stack, details, url, imageURL }) => {
  ...
  return (
    <motion.article
      ...
      className="mx-2 overflow-hidden text-gray-600 rounded-md shadow-2xl dark:text-gray-200 sm:w-96 md:w-full bg-neutral-50 dark:bg-gray-800"
    >
      ...
      <h3 className="my-3 text-2xl font-medium text-center text-gray-900 dark:text-neutral-50">
        {name}
      </h3>
